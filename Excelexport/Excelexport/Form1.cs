...
namespace Excelexport
{
    public partial class Form1 : Form
    {
        ...
        private void Createtable()
        {
            ...
            headerRange.BorderAround2(Excel.XlLineStyle.xlDashDot, Excel.XlBorderWeight.xlThick);

            int lastRowID = xlSheet.UsedRange.Rows.Count;

            Excel.Range Range = xlSheet.get_Range(GetCell(1, 9), GetCell(lastRowID,1));
            Range.BorderAround2(Excel.XlLineStyle.xlDashDot, Excel.XlBorderWeight.xlThick);
           
            Excel.Range Range2 = xlSheet.get_Range(GetCell(2, 1), GetCell(lastRowID, 1));
            Range2.Font.Bold = true;
            Range2.Interior.Color = Color.LightYellow;

            Excel.Range Range3 = xlSheet.get_Range(GetCell(2, 9), GetCell(lastRowID, 9));
            Range3.Interior.Color = Color.LightGreen;
            Range3.NumberFormat = "$#,##0.00_);[Red]($#,##0.00)";
